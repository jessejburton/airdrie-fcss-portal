...
<cfif StructKeyExists(ATTRIBUTES, "ProgramID")>
	...
	<cfif userHasAccess>	
		<div class="budget-display">
			<cfinvoke component="#APPLICATION.cfcpath#budget" method="getBudgetByBudgetType" programID="#ATTRIBUTES.ProgramID#" budgetType="Mid-Year Budget" returnvariable="BUDGET" />

			<h1>Mid-Year Budget Summary</h1>
