	...
	<section id="main_content">
		<div class="wrapper clearfix">
			<form id="mid_year_form">
				...
				<p>
					Please complete the following Mid-Year report to submit your current program status to the City of Airdrie.
				</p> 		
				...
				<div class="accordion clearfix">				
					...
					<div class="form-group seen">
						...
						<div class="form_buttons clearfix">
							<button type="button" id="midyear_review_submit" class="btn btn-primary pull-right">Submit</button> 
						</div>
					</div>										
				</div>
			</form>
...
<!--- Autoreply message when complete --->
			<div id="midyear_form_complete" class="hidden spaced">
				<p><strong>Success!</strong> you have completed and submitted your Mid-Year report. return to the <a href="programs.cfm">programs</a> page.</p>
			</div>
		</div>
	</section>	
